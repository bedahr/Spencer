...
{
    return getInstance()->getValue<QString>("host", "192.168.1.XXX"); //FIXME: something else
}
...
{
    return getInstance()->getValue<int>("cutoffLevel", 6000);
}
...
{
    return getInstance()->getValue<int>("tailMargin", 650);
}
